document.addEventListener('DOMContentLoaded', function () {
  ...
  const projects = [
    {
      ...
      category: 'fullstack',
      description:
        'The School Management System developed in Python provides an efficient, secure, and scalable solution for managing school operations digitally. It simplifies administrative tasks and improves the overall educational management process.',
      tech: ['Python', 'Django / Flask', 'HTML', 'CSS', 'JavaScript', 'MySQL / SQLite'],
      features: [
  ...
  <li>Examination and Result Management</li>
  ...
  category: 'frontend',
  description:
    'A modern, responsive personal portfolio website to showcase skills, projects, experience, and contact information with interactive UI and smooth animations.',
  ...
  category: 'backend',
  description:
    'A robust RESTful API for managing an e-commerce platform, handling products, users, orders, and payments with secure authentication and CRUD operations.',
  tech: ['Python', 'Django REST Framework', 'PostgreSQL', 'JWT', 'Docker'],
  features: [
  ...
  snippet: `# Example: Django REST Framework View
...
class ProductViewSet(viewsets.ModelViewSet):
  ...
  link: '#',
    },
    {
      ...
      category: 'fullstack',
      description:
        'A complete full-stack restaurant management system to manage menu, orders, table reservations, staff, and billing with an interactive frontend and secure backend.',
      tech: ['Python', 'Flask / Django', 'HTML', 'CSS', 'JavaScript', 'SQLite / PostgreSQL'],
      features: [
        'Interactive menu management (add/update/delete items)',
    'Order placement and real-time tracking',
    'Table reservation system',
    'Billing and invoice generation',
    'User authentication with role-based access (admin, staff, customer)',
    'Responsive design for all devices',
    'Dynamic dashboards for admin and staff',
      ],
      snippet: `restaurant = Restaurant(name="Gourmet Haven")
menu_item = MenuItem(name="Pasta Primavera", price=12.99)
  ...
  const experiences = [
    {
      ...
      description:
        'Motivated Junior Software Engineer with hands-on experiencelearning new technologies and building efficient, real-world software solutions.',
    },
